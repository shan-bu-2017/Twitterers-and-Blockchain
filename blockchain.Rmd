...
### install.packages("googleVis"), install.packages("syuzhet")
...
# please refer to http://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm about the classification
...
filterStream("tweetsUS.json", track=c("blockchain"), 
             locations = c(-125, 25, -66,50),  timeout = 100,
             oauth = my_oauth)   
```
